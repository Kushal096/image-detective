...
export const Lobby = ({ room, playerId }) => (
  <div className="max-w-md mx-auto pt-8 flex flex-col gap-4 animate-fade-in">
    <Card glow="secondary" className="text-center">
      ...
      <p className="font-display text-3xl tracking-[0.3em] text-primary">{room.code}</p>
    ...
    <Card className="flex flex-col items-center gap-3 py-8">
      <Loader2 className="size-8 text-secondary animate-spin-slow" aria-hidden />
    ...
    <Card>
      <CardHeader title="Detectives" subtitle={`${room.players.length} in the room`} icon={Users} />
